...
xsdTest(void) {
    ...
    const char *filename = SRCDIR "/xsdtest/xsdtestsuite.xml";
    int ret = 0;
...
rngTest1(void) {
    ...
    const char *filename = SRCDIR "/relaxng/OASIS/spectest.xml";
    int ret = 0;
...
rngTest2(void) {
    ...
    const char *filename = SRCDIR "/relaxng/testsuite.xml";
    int ret = 0;
...
int
libxml2_run_suite_main(int argc ATTRIBUTE_UNUSED, char **argv ATTRIBUTE_UNUSED) {
    int ret = 0;
