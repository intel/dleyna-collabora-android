...
DEFINE_TEST(gupnpav_criteria_parser_test, gupnpavCriteriaParserTest, "( upnp:class derivedfrom \"object.item.imageItem\"  or upnp:class derivedfrom \"object.item.videoItem\"  or upnp:class derivedfrom \"object.item.audioItem\"  ) and ( @refID exists false )")

// rygel

//DEFINE_TEST(rygel_test_album_art_spec, rygelTestAlbumArtSpec)
//DEFINE_TEST(rygel_test_environment, rygelTestEnvironment)
//DEFINE_TEST(rygel_test_http_byte_seek, rygelTestHttpByteSeek)
//DEFINE_TEST(rygel_test_http_get, rygelTestHttpGet)
//DEFINE_TEST(rygel_test_http_item_uri, rygelTestHttpItemUri)
//DEFINE_TEST(rygel_test_http_post, rygelTestHttpPost)
//DEFINE_TEST(rygel_test_http_response, rygelTestHttpResponse)
//DEFINE_TEST(rygel_test_http_time_seek, rygelTestHttpTimeSeek)
//DEFINE_TEST(rygel_test_media_engine, rygelTestMediaEngine)
//DEFINE_TEST(rygel_test_http_object_creator, rygelTestHttpObjectCreator)
//DEFINE_TEST(rygel_test_playbin_renderer, rygelTestPlaybinRenderer)
DEFINE_TEST(rygel_test_regression, rygelTestRegression)
DEFINE_TEST(rygel_test_searchable_container, rygelTestSearchableContainer)
//DEFINE_TEST(rygel_test_user_config, rygelTestUserConfig)
