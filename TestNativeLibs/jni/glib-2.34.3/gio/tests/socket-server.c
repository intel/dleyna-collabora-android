...
static gboolean dont_reuse_address = FALSE;
static gboolean non_blocking = FALSE;
static gboolean use_udp = FALSE;
static int cancel_timeout = 0;
static int read_timeout = 0;
static int delay = 0;
static gboolean unix_socket = FALSE;
...
int
gio_socket_server_main (int argc,
      char *argv[])
{
