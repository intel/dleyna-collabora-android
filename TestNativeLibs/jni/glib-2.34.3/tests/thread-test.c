...
run_all_tests()
{
  g_print("test_g_mutex\n");
  test_g_mutex ();
  g_print("test_g_static_rec_mutex\n");
  test_g_static_rec_mutex ();
  g_print("test_g_static_private\n");
  test_g_static_private ();
  g_print("test_g_static_rw_lock\n");
  test_g_static_rw_lock ();
  g_print("test_g_thread_once\n");
  test_g_thread_once ();
}

int 
glib_thread_test_main (int   argc,
      char *argv[])
{
  g_thread_init (NULL);
  run_all_tests ();
